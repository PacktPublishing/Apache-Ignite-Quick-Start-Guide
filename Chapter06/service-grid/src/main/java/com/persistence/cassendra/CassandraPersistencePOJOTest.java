...
public class CassandraPersistencePOJOTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String file = CassandraPersistencePOJOTest.class.getClassLoader()
				.getResource("META-INF//conference-persistence-settings.xml").getFile();
		...
		final IgniteCache<Integer, Conference> cache = ignite.getOrCreateCache("cassandra");

		// Put a conference object into cache
